        ...
        <div className="bg-white dark:bg-[#0d1936] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl flex flex-col overflow-hidden relative">
          ...
          <div className="p-5 sm:p-6 flex flex-col relative z-10">
            ...
            <div className="text-center mb-4 flex flex-col items-center">
              <div className="w-10 h-10 mb-2 rounded-xl bg-blue-500/10 text-blue-500 flex items-center justify-center shrink-0">
                <FiLayers size={20} />
              </div>
              <h1 className="text-xl font-bold text-slate-900 dark:text-white mb-1">Add Operation</h1>
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">Define a new workflow step for this department</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-end gap-3">
                ...
                <button 
                  type="submit" 
                  disabled={loading}
                  className="flex items-center gap-2 px-5 py-2 rounded-lg font-semibold text-sm text-white bg-brand-primary hover:bg-brand-secondary transition-all shadow-md shadow-brand-primary/25 disabled:opacity-60 disabled:pointer-events-none"
                >
